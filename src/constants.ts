...
export const DEFAULT_NEWS_POLLING_INTERVAL = ms(process.env.DEFAULT_NEWS_POLLING_INTERVAL!);
...
export const DEFAULT_SUBJECT_AVATAR_URL = process.env.DEFAULT_SUBJECT_AVATAR_URL!;
